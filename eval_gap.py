...
from train import BertForMaskedLM
from scorer import scorer
...
def get_test_data(examples, tokenizer, args):
    ...
    print(all_input_ids_1.shape)
    print(all_attention_mask_1.shape)
    print(all_masked_lm_1.shape)
...
def main():
    ...
    parser.add_argument('--ckpt_dir', default='/n/fs/scratch/jh70/bert-coref-0121-new-20')
    ...
    test_examples = processor.get_examples(args.data_dir, "gap-test")
    
    test_data = get_test_data(test_examples, tokenizer, args)
